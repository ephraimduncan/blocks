          ...
          <div className="flex-1 overflow-y-auto pt-2">
            <div className="flex flex-col gap-4 p-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="w-full aspect-video rounded-xl bg-blue-500 dark:bg-blue-700 flex justify-center items-center text-lg font-bold text-white">1</div>
                <div className="aspect-video rounded-xl bg-muted/50 flex justify-center items-center">2</div>
                <div className="aspect-video rounded-xl bg-muted/50 flex justify-center items-center">3</div>
              </div>
              <div className="h-64 md:h-[calc(100vh-350px)] rounded-xl bg-muted/50 flex justify-center items-center">4</div>
            </div>
          </div>
        </SidebarInset>
      </>
