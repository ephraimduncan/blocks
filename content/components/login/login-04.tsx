        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="flex items-center space-x-1.5">
            <Logo
              ...
              aria-hidden={true}
            />
            <p className="text-pretty font-medium text-lg text-foreground">
              Acme
            </p>
          </div>
          <h3 className="text-balance mt-6 text-lg font-semibold text-foreground">
          ...
          <p className="text-pretty mt-6 text-sm text-muted-foreground">
