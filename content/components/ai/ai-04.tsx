...
export default function Ai04({
  ...
  return (
    <div className="mx-auto flex w-full flex-col gap-4">
      <div className="text-balance text-pretty text-center font-heading font-semibold text-[29px] text-foreground tracking-tighter sm:text-[32px] md:text-[46px]">
        Prompt. Refine. Ship.
      </div>
      <div className="text-balance -my-5 pb-4 text-center text-xl text-muted-foreground">
